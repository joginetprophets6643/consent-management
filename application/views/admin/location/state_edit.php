      ...
      <div class="card-header">
       ...
       <!-- form start -->
        <div class="card-body">
            ...
            <?php echo form_open_multipart(base_url('admin/location/state/edit/'.urlencrypt($state['id'])), 'class="form-horizontal"');  ?> 
              ...
              <div class="form-group">
                <label for="name" class="col-sm-3 control-label">State Logo</label>
                <div class="col-sm-12">
                    <input type = "file" class="form-control" name="state_symbol" size = "20" /> 
