      ...
      <div class="card-body">
          ...
          <?php echo form_open(base_url('admin/location/country/add'), 'class="form-horizontal"');  ?> 
            <div class="form-group">
              ...
              <div class="col-sm-12">
                <input type="text" name="country" onkeypress="return (event.charCode > 64 && 
    event.charCode < 91) || (event.charCode > 96 && event.charCode < 123)" class="form-control" id="name" placeholder="">
              </div>
            </div>
            <div class="form-group">
              <div class="col-md-12">
