    ...
    <div class="card">
      <div class="card-header">
        <div class="d-inline-block">
          <h3 class="card-title"><i class="fa fa-pencil"></i>&nbsp; Edit District</h3>
        </div>
        <div class="d-inline-block float-right">
          <?php if($this->rbac->check_operation_permission('city_add')): ?>
            <a href="<?= base_url('admin/location/city/add'); ?>" class="btn btn-success"><i class="fa fa-plus"></i> Add New District</a>
          <?php endif; ?>
        </div>
      </div>
      <div class="card-body">
          <?php echo validation_errors(); ?>           
          <?php echo form_open(base_url('admin/location/city/edit/'.urlencrypt($city['id'])), 'class="form-horizontal"');  ?> 
