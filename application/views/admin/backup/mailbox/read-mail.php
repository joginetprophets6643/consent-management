          ...
          <div class="card card-primary card-outline">
            ...
            <div class="card-footer bg-white">
              <ul class="mailbox-attachments clearfix">
                ...
                <li>
                  <span class="mailbox-attachment-icon has-img"><img src="<?= base_url()?>assets/dist/img/photo1.png" alt="Attachment"></span>
                ...
                <li>
                  <span class="mailbox-attachment-icon has-img"><img src="<?= base_url()?>assets/dist/img/photo2.png" alt="Attachment"></span>
