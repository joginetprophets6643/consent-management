                    ...
                    <thead>
                     ...
                     <?php  foreach ($data   as $key=> $d){?> 
                        <tr>
                            ...
                            <td><a href="<?php echo site_url("admin/allocation_admin/allocation_list/".urlencrypt($d['id'])."/".urlencrypt($d['exam_name'])); ?>" class="btn btn-sec" ><?php echo get_exam_name($d['exam_name']);?></a></td>
