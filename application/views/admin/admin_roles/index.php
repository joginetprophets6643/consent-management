                        ...
                        <?php foreach ($records as $record): ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="<?php echo site_url("admin/admin_roles/access/" . urlencrypt($record['admin_role_id'])); ?>" class="btn btn-info btn-xs mr5" >
                                ...
                                <td>
                                    ...
                                    <?php if (!in_array($record['admin_role_id'], array(1))): ?>
                                        ...
                                        <a href="<?php echo site_url("admin/admin_roles/edit/" . urlencrypt($record['admin_role_id'])); ?>" class="btn btn-warning btn-xs mr5" >
                                        ...
                                        <a href="<?php echo site_url("admin/admin_roles/delete/" . urlencrypt($record['admin_role_id'])); ?>" onclick="return confirm('are you sure to delete?')" class="btn btn-danger btn-xs"><i class="fa fa-remove"></i></a>
