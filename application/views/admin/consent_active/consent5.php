                        ...
                        <div class="form">
                            ...
                            <div class="right-side">
                                ...
                                <div class="main active" id="upload_from">
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="file"
                                                style="height: 35px !important; font-size: 14px !important;"
                                                class="form-control ImageValidationClass" name="fileName1"
                                                id="fileName1" data-file_detail="file_detail1" />
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="file"
                                                style="height: 35px !important; font-size: 14px !important;"
                                                class="form-control ImageValidationClass" name="fileName2"
                                                id="fileName2" data-file_detail="file_detail2" />
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="file"
                                                style="height: 35px !important; font-size: 14px !important;"
                                                class="form-control ImageValidationClass" name="fileName3"
                                                id="fileName3" data-file_detail="file_detail3" />
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="file"
                                                style="height: 35px !important; font-size: 14px !important;"
                                                class="form-control ImageValidationClass" name="fileName4"
                                                id="fileName4" data-file_detail="file_detail4" />
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="file"
                                                style="height: 35px !important; font-size: 14px !important;"
                                                class="form-control ImageValidationClass" name="fileName5"
                                                id="fileName5" data-file_detail="file_detail5" />
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="file"
                                                style="height: 35px !important; font-size: 14px !important;"
                                                class="form-control ImageValidationClass" name="fileName6"
                                                id="fileName6" data-file_detail="file_detail5" />
                                    ...
                                    <div class="row mt-4">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <input type="hidden" id="yes" id="examincation_ids"
                                                                    name="examincation_ids"
                                                                    value="<?= $val['sub_name'] ?>">
                                                                <input type="radio" id="yes"
                                                                    onclick="optionFunction('<?=$passValue?>','yes')"
                                                                    name="exmin_ceter_option[]<?= $x; ?>" value="Yes"
                                                                    checked>Yes
                                                                <input type="radio" id="no"
                                                                    onclick="optionFunction('<?=$passValue?>','no')"
                                                                    name="exmin_ceter_option[]<?= $x; ?>" value="No">No
                                                                <input type="hidden" name="examincation_id"
                                                                    id="examincation_id" value="<?= $all_value; ?>" />
                                                            </td>
                                                            <!-- <?//php// }?> -->
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="form-group">
                                                <a href="<?= base_url("admin/consent_active/consent_add_4".'/'.$segment_value ); ?>"
                                                    id="dwn" class="btn btn-sec">
                                                    Back
                                                </a>
                                ...
                                <div class="main active" id="from_upload_show">
                                    <div class="text ">
                                        <h2>Upload Downloaded Consent Form (Signed and Stamped)<span
                                                class="formatColor">(Only PDF & Maximum size 30MB)* </span></h2>
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-12">
                                            <input type="file"
                                                style="height: 35px !important; font-size: 14px !important;"
                                                class="form-control pdfValidationClass" name="from_upload_file"
