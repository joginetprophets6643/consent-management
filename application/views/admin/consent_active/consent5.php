                                    ...
                                    <div class="main active" id="upload_from">
                                        ...
                                        <div class="row">
                                            <div class="form-group col-md-6">
                                                <label>Parking Area Image <span class="formatColor">(JPG format Only)* </span><i style="color:#ff0000; font-size:12px;">*</i>
                                                </label>
                                                <input type="file" style="height: 35px !important; font-size: 14px !important;" class="form-control ImageValidationClass" name="fileName1" id="fileName1"
                                                    data-file_detail="file_detail1"  />
                                                
                                            </div>
                                            <div class="form-group col-md-6">
                                                <label>Classroom Image <span class="formatColor">(JPG format Only)* </span><i
                                                        style="color:#ff0000; font-size:12px;">*</i></label>
                                                <input type="file" style="height: 35px !important; font-size: 14px !important;" class="form-control ImageValidationClass" name="fileName2" id="fileName2"
                                                    data-file_detail="file_detail2"  />
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="form-group col-md-6">
                                                <label>Furniture Image <span class="formatColor">(JPG format Only)* </span><i
                                                        style="color:#ff0000; font-size:12px;">*</i></label>
                                                <input type="file" style="height: 35px !important; font-size: 14px !important;" class="form-control ImageValidationClass" name="fileName3" id="fileName3"
                                                    data-file_detail="file_detail3"  />
                                                
                                            </div>
                                            <div class="form-group col-md-6">
                                                <label>Class Room Image 2 <span class="formatColor">(JPG format Only)* </span><i
                                                        style="color:#ff0000; font-size:12px;">*</i></label>
                                                <input type="file" style="height: 35px !important; font-size: 14px !important;" class="form-control ImageValidationClass" name="fileName4" id="fileName4"
                                                    data-file_detail="file_detail4"  />
                                                
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="form-group col-md-6">
                                                <label>Cloak Room Image <span class="formatColor">(JPG format Only)* </span><i
                                                        style="color:#ff0000; font-size:12px;">*</i></label>
                                                <input type="file" style="height: 35px !important; font-size: 14px !important;" class="form-control ImageValidationClass" name="fileName5" id="fileName5"
                                                    data-file_detail="file_detail5"  />
                                                
                                            </div>
                                            <div class="form-group col-md-6">
                                                <label>Main Gate image <span class="formatColor">(JPG format Only)* </span><i
                                                        style="color:#ff0000; font-size:12px;">*</i></label>
                                                <input type="file" style="height: 35px !important; font-size: 14px !important;" class="form-control ImageValidationClass" name="fileName6" id="fileName6"
                                                    data-file_detail="file_detail5"  />
                                    ...
                                    <div class="main active" id="from_upload_show">
                                        ...
                                        <div class="row">
                                            <div class="form-group col-md-12">
                                                <input type="file" style="height: 35px !important; font-size: 14px !important;" class="form-control pdfValidationClass" name="from_upload_file"
                ...
                $(document).ready(function () {
			        ...
			        $('.ImageValidationClass').change(function() {
			           ...
			           $('.pdfValidationClass').change(function() {
			            ...
			            // alert($('.pdfValidationClass').files[0]);
