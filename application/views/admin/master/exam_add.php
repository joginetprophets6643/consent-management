                ...
                <div class="row">   
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" name="end_date_exam" class="form-control date_disable" min="2023-05-25" id="end_date_exam" placeholder="">
...
$('#start_date_exam').change(function () {
     $('#end_date_exam').attr('min', $("#start_date_exam").val());
});
