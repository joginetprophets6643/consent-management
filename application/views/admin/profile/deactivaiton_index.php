            ...
            <div class="card-body">
                <div class="d-inline-block">
                  <h3 class="card-title">
                   ...
                   Account Deactivation List
                  </h3>
                    
              </div>
                <div class="d-inline-block float-right">
      <?php if($_SESSION['admin_role_id'] == 6){?>
            <a href="<?= base_url('admin/profile/account_deactivation_add'); ?>" class="btn btn-success"><i class="fa fa-plus"></i> Add Deactivation Request </a>
          <?php //endif; ?>
            <?php } ?>
            ...
            <div class="card-body" >
                ...
                <div class="row">
                    <?php 
                    if (in_array($_SESSION['admin_role_id'], array(1,2))){?>
                    <div class="col-md-3">
                    ...
                    <?php }
                    if (in_array($_SESSION['admin_role_id'], array(1,2,3,4))){
                        ...
                        <div class="form-group">
                            <select name="status" class="form-control" onchange="filter_data()" >
                                ...
                                <?php foreach(ALLOWED_FILE_MOVEMENT_ROLE_ID[1] as $k=>$v):
                                    if (in_array($_SESSION['admin_role_id'], array(2,3,4,5)) && $k==1)
                                        continue;
                                        ?>
...
$.post('<?=base_url('admin/certificate/filterdata')?>',$('.filterdata').serialize(),function(){
    $('.data_container').load('<?=base_url('admin/profile/deactivation_list')?>');
});
}
//------------------------------------------------------------------
