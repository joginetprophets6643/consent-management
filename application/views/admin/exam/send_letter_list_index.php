...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="card">
            ...
            <div class="card-header border-0">
                ...
                <div class="d-inline-block">
                  ...
                  <h3 class="card-title">
                   ...
                   Send Consent List&nbsp;(सहमति सूची भेजें)
          ...
          <!--   <a style="display:block;" href="<?= base_url('admin/examshedule_schedule/create_invt_add'); ?>" class="btn btn-success"> Create  </a> -->
...
$.post('<?=base_url('admin/certificate/filterdata')?>',$('.filterdata').serialize(),function(){
	...
	$('.data_container').load('<?=base_url('admin/examshedule_schedule/send_consent_list_data')?>');
