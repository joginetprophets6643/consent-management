    ...
    <section class="content">
        ...
        <div class="card">
          ...
          <?php //if($this->rbac->check_operation_permission('country_add')): ?>
            <a style="display:block;" href="<?= base_url('admin/examshedule_schedule/date_sheet_list_add'); ?>" class="btn btn-success"> Create Date Sheet </a>
          <?php //endif; ?>
        </div>
...
$.post('<?=base_url('admin/certificate/filterdata')?>',$('.filterdata').serialize(),function(){
	$('.data_container').load('<?=base_url('admin/examshedule_schedule/datesheet_list_data')?>');
});
}
//------------------------------------------------------------------
