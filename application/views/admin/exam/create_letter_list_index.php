            ...
            <div class="card-header border-0">
              ...
              <div class="d-inline-block float-right">
                ...
                <?php //if($this->rbac->check_operation_permission('country_add')): ?>
                  ...
                  <!-- <a style="display:block;" href="<?= base_url('admin/examshedule_schedule/create_invt_add'); ?>" class="btn btn-success"> Create Letter&nbsp;(पत्र बनाएँ)  </a> -->
                  <a  style="display:none;" href="<?= base_url('admin/examshedule_schedule/create_invt_add'); ?>" class="btn btn-success"> Create Letter&nbsp;(पत्र बनाएँ)  </a>
...
$.post('<?=base_url('admin/certificate/filterdata')?>',$('.filterdata').serialize(),function(){
	...
	$('.data_container').load('<?=base_url('admin/examshedule_schedule/create_letter_list_data')?>');
