                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-group mb-4">
                                ...
                                <input type="text" id="exam_name" name="exam_name" readonly class="form-control"
                                    ...
                                    placeholder="subject line" value="<?= get_exam_name($exam[0]['exam_name'])?>">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group mb-4">
                                ...
                                <input type="text" name="startdate" id="startdate" readonly class="form-control"
                                    ...
                                    placeholder="Subject" value="<?= date("d-m-Y", strtotime( $exam[0]['startdate']))?>">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group mb-4">
                                ...
                                <input type="text" id="end_date" name="enddate" readonly class="form-control"
                                    ...
                                    placeholder="Subject" value="<?= date("d-m-Y", strtotime( $exam[0]['enddate']))?>">
