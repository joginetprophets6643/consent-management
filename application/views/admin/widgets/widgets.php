            ...
            <div class="card card-widget widget-user-2">
              ...
              <div class="widget-user-header bg-warning">
                <div class="widget-user-image">
                  <img class="img-circle elevation-2" src="<?= base_url() ?>assets/dist/img/user7-128x128.jpg" alt="User Avatar">
                </div>
                <!-- /.widget-user-image -->
          ...
          <div class="col-md-6">
            ...
            <div class="card card-widget">
              ...
              <div class="card-footer card-comments">
                ...
                <div class="card-comment">
                  <!-- User image -->
                  <img class="img-circle img-sm" src="<?= base_url() ?>assets/dist/img/user4-128x128.jpg" alt="User Image">
            ...
            <div class="card card-widget">
              ...
              <div class="card-body">
                ...
                <div class="attachment-block clearfix">
                  <img class="attachment-img" src="<?= base_url() ?>assets/dist/img/photo1.png" alt="Attachment Image">
