$(document).ready(function () {
    ...
    $("#xin-form")["submit"](function (d)
    {
        ...
        if ($("#establishment_address1").val() == "") {
            ...
            return false;
        }if ($("#establishment_city").val() == "") {
            alert("Please fill 'Village/Town/City' field");
            $("#establishment_city").focus();
            return false;
        }
        ...
        if ($("#person_registration").val() == "") {
            ...
            $("#person_registration").focus();
            return false;
        }if ($("#person_central_cauncil").val() == "") {
            alert("Please fill 'Name of Central/State Council (with which registered)' field");
            $("#person_central_cauncil").focus();
            return false;
        }if ($("#person_std").val() == "") {
            alert("Please fill 'STD' field");
            $("#person_std").focus();
            return false;
        }if ($("#person_tele").val() == "") {
            alert("Please fill 'Telephone' field");
